...
#### 간단 소개 
이미지적 접근을 통한 국토의 공간적 특성 반영한 코로나 확산 예측 <br>
#### 문제 인식 
코로나-19를 초기대책을 마련하는데는 가용할 수 있는 인적, 물적자원이 한정적이라는 문제<br>
#### 제안 이유
- 지역별 확진자 발생 추이를 예측함으로써 중앙정부 차원에서 코로나 2차 대유행이나 장기화를 사전에 대비한 전략을 수립할 수 있도록 지원
